...
public class StudentUpdate {
        ...
        update.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    String query = "UPDATE student SET FirstName=?, LastName=?, Email=?, Phone=?,Class=?,Address=?,Dateofbirth=? WHERE Id=?";
                    ...
                    preparedStatement.setString(7, DOBField.getText());
                    preparedStatement.setString(8, id.getText());
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new StudentUpdate());
    }
}
